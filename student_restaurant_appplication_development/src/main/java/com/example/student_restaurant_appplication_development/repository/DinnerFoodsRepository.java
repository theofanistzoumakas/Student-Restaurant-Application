...
import com.example.student_restaurant_appplication_development.model.DinnerFoods;
...
@Repository
public interface DinnerFoodsRepository extends JpaRepository<DinnerFoods, Long> {
