...
import com.example.student_restaurant_appplication_development.model.BreakfastFoods;
...
@Repository
public interface BreakFastFoodsRepository extends JpaRepository<BreakfastFoods, Long> {
